...
import '../../core/models/chat_message_model.dart'; // Keep for type reference if needed by UI
      ...
      appBar: AppBar(
        title: BlocBuilder<ChatBloc, ChatState>(
          builder: (context, state) {
            // Display conversation title from ChatBloc state if available
        ...
        actions: [
          BlocBuilder<ChatBloc, ChatState>(
            builder: (context, state) {
              ...
              // Placeholder for other actions like regenerate
              if (state.messages.isNotEmpty && state.messages.any((m) => m.sender == MessageSender.ai)) {
                 return IconButton(
          ...
          Expanded(
            child: BlocConsumer<ChatBloc, ChatState>(
              ...
              builder: (context, state) {
                ...
                // Use a ListView.builder for messages
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return MessageBubble(
                      ...
                      sender: message.sender == MessageSender.user
                          ...
                          : MessageBubbleSender.ai, // System messages also appear as AI
                    );
                  },
                );
              },
